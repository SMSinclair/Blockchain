...
def mine():
    ...
    # check that proof and id are included
    if r['proof'] and r['id']:
        proof = r['proof']
        uid = r['id']
    else:
        response = {
            'message': '400: Must include proof and id.'
            }
        return jsonify(response), 400
    ...
    if blockchain.valid_proof(block_string, proof):
        ...
        block_index = blockchain.new_transaction(0, uid, 1) #reward for mining a block
        ...
        response = {
            ...
            'block': new_block,
            'message': f"Reward paid in block {block_index}"
        }
